      ...
      <table width="96%" border="0" cellpadding="0" cellspacing="0" bgcolor="#eaf4ff">
        <tr>
          ...
          <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1">
              ...
              <tr> 
                <td colspan="4" align="left" class="hdrYellow2"><strong>User Search Results</strong>
				<h3>Users Matches Found</h3>
Total : <strong><?php echo $totRows ?></strong>
              ...
              <tr> 
                <td colspan="2" align="left"><a href="<?php echo base_url()?>users/finduser" title="search again">Search Again</a></td>
