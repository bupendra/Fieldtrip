			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="dataLabel" style="text-align:center;">						
						<form name="iframe_frm" method="POST" action="index.php" onSubmit="return (add_checks(document.iframe_frm) && check_form('iframe_frm'));">
...
<script>
	function show_urlupdate(){
		document.getElementById('url_container').style.display = 'inline';
